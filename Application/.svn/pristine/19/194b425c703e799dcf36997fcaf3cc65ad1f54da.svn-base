...
foreach ($reportData as $v) {
    ...
    $dataList = array(
        ...
        'warName' => $warehouseModel->queryClientByCode($data['warCode'])['war_name']
    );
    if (isset($data['spCode'])) {
        $dataList['spCode'] = $data['spCode'];
    }
    if (isset($data['supCode'])) {
        $dataList['supCode'] = $data['supCode'];
    }
    if (isset($data['spType'])) {
        $dataList['spType'] = $data['spType'];
    }
    if (isset($data['spSubtype'])) {
        $dataList['spSubtype'] = $data['spSubtype'];
    }
